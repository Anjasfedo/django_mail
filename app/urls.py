...
urlpatterns = [
    ...
    path('incoming-mail-export', views.incoming_mail_export, name='incoming_mail_export'),
    ...
    path('outgoing-mail-export', views.outgoing_mail_export, name='outgoing_mail_export'),
    ...
    path('incoming-disposition-export', views.incoming_disposition_export, name='incoming_disposition_export'),
    ...
    path('outgoing-disposition-export', views.outgoing_disposition_export, name='outgoing_disposition_export'),
